...
(function() {
    ...
    var Icon = ({ name, size = 20, className = "" }) => {
        const paths = {
            ...
            arrowLeft: h("g", null, h("line", { x1: "19", y1: "12", x2: "5", y2: "12" }), h("polyline", { points: "12 19 5 12 12 5" })),
            arrowRight: h("g", null, h("line", { x1: "5", y1: "12", x2: "19", y2: "12" }), h("polyline", { points: "12 5 19 12 12 19" }))
        };
    ...
    var App = function() {
        ...
        const handleWage = ({ onFeedback } = {}) => runHandleWage({
            config,
            students,
            history,
            getNow,
        ...
        return h("div", { className: "min-h-screen w-full min-w-0 pb-20" },
            h(NavView, { activeTab, setActiveTab, syncStatus, config }),
            h("main", { className: "w-full min-w-0 max-w-6xl mx-auto p-4 mt-4" },
